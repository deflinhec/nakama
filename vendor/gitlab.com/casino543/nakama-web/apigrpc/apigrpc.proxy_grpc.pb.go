...
type WebProxyClient interface {
	...
	VerifyVerificationCode(ctx context.Context, in *api.VerifyVerificationCodeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *webProxyClient) VerifyVerificationCode(ctx context.Context, in *api.VerifyVerificationCodeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type WebProxyServer interface {
	// Get available features from web ui.
	VerifyVerificationCode(context.Context, *api.VerifyVerificationCodeRequest) (*emptypb.Empty, error)
...
func (UnimplementedWebProxyServer) VerifyVerificationCode(context.Context, *api.VerifyVerificationCodeRequest) (*emptypb.Empty, error) {
...
func _WebProxy_VerifyVerificationCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(api.VerifyVerificationCodeRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebProxyServer).VerifyVerificationCode(ctx, req.(*api.VerifyVerificationCodeRequest))
	}
...
var WebProxy_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "apigrpc/apigrpc.proxy.proto",
}
