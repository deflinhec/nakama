...
func NewAPIServer(t *testing.T, runtime *Runtime) (*ApiServer, *Pipeline) {
	...
	apiServer := StartApiServer(logger, logger, db, protojsonMarshaler, protojsonUnmarshaler, cfg, "3.0.0", nil, nil, nil, nil, nil, nil, nil, nil, nil, tracker, router, nil, metrics, pipeline, runtime)
